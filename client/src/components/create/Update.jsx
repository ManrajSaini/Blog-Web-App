...
const Update = () => {
    ...
    const [imageURL, setImageURL] = useState('https://i.postimg.cc/PxW4LJ4J/pexels-suzy-hazelwood-1995842.jpg');
  ...
  const getImage = async () => { 
    if(file) {
      ...
      setImageURL(post.picture || imageURL);
    }
  };
  getImage();
}, [file, post.picture, imageURL]);
